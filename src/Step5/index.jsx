    ...
    >
      ...
      <div className="MuiBox-root jss482 jss481">
        ...
        <div className="MuiPaper-root jss488 MuiPaper-elevation4">
              ...
              <div className="MuiBox-root jss208">
                ...
                <h6 className="MuiTypography-root MuiTypography-subtitle1 jss211 jss212">
                  <div className="MuiBox-root jss213">
                    Go through the per diem rates summary before saving it
                  </div>
                </h6>
              </div>
            </div>
          ...
          <div className="MuiBox-root jss504 jss4955">
            <div className="MuiBox-root jss5505">
              <div className="MuiBox-root jss506 jss4966">
                <div className="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                  <div className="MuiGrid-root MuiGrid-container MuiGrid-wrap-xs-nowrap MuiGrid-align-items-xs-center">
                    <div className="MuiBox-root jss5133">
                      <div
                        className="MuiBox-root jss5144"
                        style={{
                    ...
                    <div className="MuiBox-root jss5516 jss5510">
                      <div
            ...
            <div className="MuiBox-root jss5550">
              ...
              <div className="MuiBox-root jss5553">
                <div className="MuiBox-root jss5554">
